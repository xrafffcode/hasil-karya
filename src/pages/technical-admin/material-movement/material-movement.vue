<template>
  <VRow>
    <VCol cols="12" class="d-flex justify-space-between align-items-center">
      ...
      <VBtn :to="{ name: 'admin-material-movement' }" color="primary">
        Kembali
      </VBtn>
    </VCol>
      ...
      <VCard>
        <VForm>
          <VRow>
            ...
            <VCol cols="12" md="6">
              <VTextField v-model="date" label="Tanggal" placeholder="Tanggal Material Movement"
                :error-messages="error && error.date ? [error.date] : []" type="datetime-local" readonly="" />
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VSelect v-model="driver_id" :items="drivers" label="Driver" placeholder="Pilih Driver"
                ...
                :item-value="driver => driver.id" readonly="" />
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VSelect v-model="truck_id" :items="trucks" label="Truck" placeholder="Pilih Truck"
                ...
                :item-value="truck => truck.id" readonly="" />
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VSelect v-model="station_id" :items="stations" label="POS" placeholder="Pilih POS"
                ...
                :item-title="station => station.name" :item-value="station => station.id" readonly="" />
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VSelect v-model="checker_id" :items="checkers" label="Pemeriksa" placeholder="Pilih Pemeriksa"
                ...
                :item-title="checker => checker.name" :item-value="checker => checker.id" readonly="" />
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VTextField v-model="observation_ratio_percentage" label="Presentase Rasio Index"
                ...
                type="number" step="1" suffix="%" readonly="" />
            </VCol>

            <VCol cols="12" md="6">
              <VTextField v-model="observation_ratio_number" label="Rasio Index" placeholder="Rasio Index"
                :error-messages="error && error.observation_ratio_number ? [error.observation_ratio_number] : []"
                type="number" suffix="m³" readonly="" />
            </VCol>

            <VCol cols="12" md="6">
              <VTextField v-model="solid_ratio" label="Rasio Padat" placeholder="Rasio Padat"
                :error-messages="error && error.solid_ratio ? [error.solid_ratio] : []" type="number" step="1"
                suffix="%" readonly="" />
            </VCol>

            <VCol cols="12" md="6">
              <VTextField v-model="solid_volume_estimate" label="Estimasi Volume" placeholder="Estimasi Volume"
